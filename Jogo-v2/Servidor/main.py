...
server_thread = threading.Thread(target=sck.start_server, args=[nJogadores,connections])
server_thread.start()

# Inicializa o jogo quando houver nJogadores
start_game_thread = threading.Thread(target=jg.handle_game, args=(dim, nJogadores,connections))
